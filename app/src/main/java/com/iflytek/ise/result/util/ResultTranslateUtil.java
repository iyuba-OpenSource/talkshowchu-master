...
//
//	private static final HashMap<Integer, String> dp_message_map = new HashMap<Integer, String>();
//	private static final HashMap<String, String> special_content_map = new HashMap<String, String>();
//
//	static {
