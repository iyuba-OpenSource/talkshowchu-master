...
public class AudioEncoder implements Runnable {
    ...
    private final int channelCount = 2;     //音频采样通道，默认2通道
    private final int channelConfig = AudioFormat.CHANNEL_IN_STEREO;        //通道设置，默认立体声
    private final int audioFormat = AudioFormat.ENCODING_PCM_16BIT;     //设置采样数据格式，默认16比特PCM
