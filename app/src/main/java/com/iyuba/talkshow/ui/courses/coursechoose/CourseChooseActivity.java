...
//    private ChooseCourseFragment fragment;
    private ChooseCourseFragment fragment;
    private int type;
    private int flag;
    ...
    private void initFragment() {
        if (type == OpenFlag.TO_WORD) {
            fragment = ChooseCourseFragment.build("" + configManager.getWordCategory(), flag, type);
        } else {
            fragment = ChooseCourseFragment.build("" + configManager.getCourseCategory(), flag, type);
        }
