...
//
//    @Inject
//    public FixLoginPresenter(DataManager dataManager, GetLocation getLocation) {
...
//
//                        getMvpView().startToImprover(user.getUid());
...
//                        MessageFormat.format(
//                                ((Context) getMvpView()).getString(R.string.welcome_back), username));
//                getMvpView().startToImprover(UserInfoManager.getInstance().getUserId());
//                ((Activity) getMvpView()).finish();
//            }
//
//            @Override
...
//                                mAccountManager.saveUser(user);*/
//                                //使用2001接口获取数据
//                                UserInfoManager.getInstance().getRemoteUserInfo(response.userinfo.uid(), new UserinfoCallbackListener() {
//                                    @Override
//                                    public void onSuccess() {
//                                        EventBus.getDefault().post(new LoginEvent());
...
//                                    @Override
//                                    public void onFail(String errorMsg) {
//                                        ToastUtil.showToast(ResUtil.getInstance().getContext(), "获取用户信息失败");
//                                    }
//                                });
//                                return;
//                            }
...
//                    public void onError(Throwable e) {
//                        if (getMvpView()!=null){
//                            getMvpView().showUserInfo(uid,false);
//                        }
//                    }
//
//                    @Override
