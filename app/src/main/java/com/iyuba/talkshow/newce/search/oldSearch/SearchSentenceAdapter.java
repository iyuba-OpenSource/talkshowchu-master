...
//import com.iyuba.talkshow.newce.study.exercise.util.ExerciseFixTimerSingle;
//import com.iyuba.talkshow.newce.study.exercise.util.ExerciseSingle;
//import com.iyuba.talkshow.newce.study.exercise.view.ExercisePlayer;
...
//
//    public SearchSentenceAdapter(Context context, List<VoaText> list,SearchPresenter presenter) {
...
//            selectHolder.record.setBackgroundResource(R.mipmap.sen_i_read_new);
//        }
...
//                EvaluateRequset.post(Constant.Web.EVALUATE_URL_CORRECT, map, audioPath, handler);
//            }catch (Exception e){
//                e.printStackTrace();
...
//                    readBar.setBackgroundResource(R.mipmap.play_ok_new);
...
//        String audioUrl = Constant.getSoundCommonUrl(selectVoa.sound(),selectVoa.voaId());
//        //获取名称
