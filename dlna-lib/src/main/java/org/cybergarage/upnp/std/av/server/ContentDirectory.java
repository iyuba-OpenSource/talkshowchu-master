...
public class ContentDirectory extends ThreadCore implements ActionListener, QueryListener
{
	...
	private final FormatList formatList = new FormatList();
	...
	*/
	...
	private final SortCapList sortCapList = new SortCapList();
	...
	private final SearchCapList searchCapList = new SearchCapList();
	...
	private final DirectoryList dirList = new DirectoryList();
